...
public class QuestsEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		content.tooltip = "Если в проекте несколько квестовых систем, этот ID позволяет дать каждой системе уникальность, чтобы избежать дублирования id квестов";
		...
		targetObject.isCanOptimize = EditorGUILayout.Toggle("Can optimize", targetObject.isCanOptimize);
