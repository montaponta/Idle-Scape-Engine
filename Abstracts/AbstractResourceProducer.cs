...
public abstract class AbstractResourceProducer : MainRefs, IIDExtention, ISODataHandler, IObjectObservable
{
    ...
    {
        if (produceResource.produceTime > 0)
        ...
        arr[0] = new CollectablesItemCount { resourceType = produceResource.produceResourceType, count = GetRemainResourceCount(produceResource.produceResourceType) };
        arr[1] = this;
